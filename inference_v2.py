...
parser.add_argument('--face_landmarks_detector_path', default='checkpoints/face_landmarker_v2_with_blendshapes.task',
...
def main():
	...
	if not args.audio.endswith('.wav'):
		...
		command = 'ffmpeg -hide_banner -loglevel error -y -i {} -strict -2 {}'.format(args.audio, 'temp/temp.wav')
	...
	command = 'ffmpeg -hide_banner -loglevel error -y -i {} -i {} -strict -2 -q:v 1 {}'.format(args.audio, 'temp/result.avi', args.outfile)
